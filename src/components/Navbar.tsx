        ...
        <div className="flex-1 xl:flex-none flex items-center justify-end gap-2 md:gap-4 xl:gap-10 shrink-0">
          ...
          {user ? (
            <div className="hidden md:flex items-center gap-4 xl:gap-6">
              ...
              <button aria-label="Log out" onClick={onLogout} className={`${isDarkMode ? 'text-brand-beige/40 hover:text-brand-gold' : 'text-brand-blue/40 hover:text-brand-gold'} transition-colors p-1`}><LogOut size={18} /></button>
            </div>
          ) : (
