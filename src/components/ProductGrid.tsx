...
export default function ProductGrid({ products, onAddToCart, onToggleWishlist, onProductClick, wishlist, isLoading = false }: ProductGridProps) {
  ...
  // Pre-compute wishlisted product IDs to change lookup from O(N*M) to O(N+M)
  // This significantly improves render performance for large product grids and wishlists
