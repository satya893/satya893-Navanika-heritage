...
export default function ProductGrid({ products, onAddToCart, onToggleWishlist, onProductClick, wishlist, isLoading = false }: ProductGridProps) {
  ...
  // ⚡ Bolt Optimization: Memoize wishlist item IDs to convert O(n²) lookup to O(n) hash map lookup
  // This reduces the time complexity of rendering the product grid from O(products * wishlist) to O(products + wishlist)
