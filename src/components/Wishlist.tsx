        ...
        >
          <div className="p-10 flex justify-between items-center border-b border-brand-blue/5 dark:border-white/10 bg-brand-beige/20 dark:bg-white/5">
            ...
            <button
              ...
              onClick={onClose}
              className="p-2 hover:bg-brand-blue/5 dark:hover:bg-white/5 rounded-full transition-colors text-brand-blue/40 dark:text-brand-beige/40 hover:text-brand-blue dark:hover:text-brand-beige"
            >
              <X size={20} />
            </button>
          </div>
                  ...
                  <div className="flex-1 py-1 flex flex-col justify-between">
                    <div className="flex justify-between items-start">
                      ...
                      <button
                        ...
                        className="text-brand-blue/20 dark:text-brand-beige/20 hover:text-red-500 transition-colors"
                      >
                        <Trash2 size={16} />
                      </button>
                    </div>
                    <button className="w-full mt-4 bg-brand-blue/5 dark:bg-white/5 text-brand-blue/80 dark:text-brand-beige/80 py-3 text-[10px] uppercase tracking-widest font-bold hover:bg-brand-gold hover:text-white transition-all">
                      Move to Cart
                    </button>
                  </div>
                </div>
